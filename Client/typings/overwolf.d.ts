declare namespace overwolf {
 ...
 "\r\n or an error message if not:\r\n "
  ...
  namespace windows {
     ...
     */
    function changeSize(windowId: string, width: number, height: number, callback: (data: any) => void): void
     ...
     */
    function changePosition(windowId: string, left: number, top: number, callback: (data: any) => void): void
     ...
     */
    function getOpenWindows(callback: (data: any) => any): void
  ...
  namespace games {
     ...
     */
    function getGameInfo(gameClassId: number, callback: (payload: any) => void): void
 ...
 "\r\n or an error message if not:\r\n "
  ...
  namespace utils {
     ...
     */
    function getSystemInformation(callback: (data: any) => void): void
